...
Task.Wait()
local DAMAGE_TO_PLAYERS = ROOT:GetCustomProperty("DamageToPlayers") or 10
...
function OnProjectileImpact(projectile, other, hitResult)
	...
	local sourceObject = script.parent:FindChildByName("NPCAIServer")
	
	-- Apply the damage
	COMBAT().ApplyDamage(other, dmg, sourceObject, pos, rot)
