...
function NavMesh.FindPath(startPoint, endPoint)
	...
	--[[
	local pathNodeMetatable = {
        __le = function(a, b) return (a.lengthPlusHeuristic - a.length) <= (b.lengthPlusHeuristic - b.length) end,
        __lt = function(a, b) return (a.lengthPlusHeuristic - a.length) < (b.lengthPlusHeuristic - b.length) end
    }]]
